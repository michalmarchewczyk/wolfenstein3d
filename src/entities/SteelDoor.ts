...
class SteelDoor implements Entity {
	public state = 1;
	...
	constructor(public x:number = 0, public y:number = 0, public direction:'NS' | 'EW' = 'NS') {
		if (this.direction === 'NS') {
			this.sprites.push(new Sprite(this.x, this.y, spriteTextures.doorSteel, false, SpriteType.NS));
			this.sprites.push(new Sprite(this.x, this.y + 0.49, spriteTextures.door2, false, SpriteType.EW));
			this.sprites.push(new Sprite(this.x, this.y - 0.49, spriteTextures.door2, false, SpriteType.EW));
		} else {
			this.sprites.push(new Sprite(this.x, this.y, spriteTextures.doorSteel, false, SpriteType.EW));
